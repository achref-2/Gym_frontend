...
class Login extends React.Component{
  render(){
    ...
    <div class="h-full">
      ...
      <div class="container pt-10 md:pt-10 mx-auto flex flex-wrap flex-col md:flex-row items-center ml-0 mt-12 ">
      <div class="w-full xl:w-3/5 p-12 overflow-hidden mb-12 ">
          <img class="mx-auto w-full md:w-4/5 transform -rotate-5 transition hover:scale-105 duration-700 ease-in-out hover:rotate-6" src="./img/pic2.png" />
        </div>
        <div class="flex flex-col w-full xl:w-2/5 justify-center lg:items-start overflow-y-hidden">
          <h1 class="my-4 text-3xl md:text-5xl text-white opacity-75 font-bold leading-tight text-center md:text-left mt-10">
          Hello 
          ...
          <form class="bg-gray-900 opacity-75 w-full shadow-lg rounded-lg px-8 pt-6 pb-8 ">
            <div class="mb-4">
          ...
          <p class="leading-normal text-base md:text-1.5xl mb-8 text-center md:text-left">
          build your muscles with us
          </p>
        </div>   
        <div class="w-full pt-16 pb-6 text-sm text-center md:text-left fade-in mb-9">
